...
library("xlsx")
#read in data
WBD=read.xlsx2("WBD-R.xlsx", sheetIndex = 1, header = TRUE)
#remove the replicated or useless columns
WBD=WBD[, c(-2, -4)]
...
WBD[WBD==".."] = ""
summary(WBD)
# write.table(WBD, file = "WBDna.csv", row.names = FALSE, col.names = TRUE, na = "", sep=",")

WBD = read.csv("WBDCleanCN.csv", header = TRUE)
colnames(WBD)= c("Variable", "countryName","1990","2000","2008", "2009", "2010", "2011", "2012", "2013", "2014", "2015", "2016", "2017")
summary(WBD)
...
#export the csv file
write.table(Out1990, file = "WBD1990.csv", row.names = FALSE, col.names = TRUE, na = "", sep=",")
...
write.table(Out1990, file = "SN1990.csv", row.names = FALSE, col.names = TRUE, na = "", sep=",")
...
#export the csv file
write.table(Out2000, file = "WBD2000.csv", row.names = FALSE, col.names = TRUE, na = "", sep=",")
colnames(Out2000)<-c("CN",	"GDP",	"FDINI", "NFA",	"GDPg",	"GDPpcg",	"GCaFg",	"Ind1",	"ind2",	"Ser",	"ExGSgp",	
                    "ADRold",	"ADRyoun",	"PPg",	"PPf",	"PPm",	"PP1519f",	"PP1519m",	"PP2024f",	"PP2024m",	
                    "PP2529m",	"PP2529f",	"PP65above",	"PP65afnum",	"PP65af",	"PP1564m",	"PP1564f",	"Lab1524f",	
                    "Lab1524m",	"Lab1524tot",	"Labf",	"Labtot",	"RFtoMlabpartcp")
summary(Out2000)
write.table(Out2000, file = "SN2000.csv", row.names = FALSE, col.names = TRUE, na = "", sep=",")
#------------------------------------2008------------------------------------------------------------------
WBD2008 = WBD[,c(1,2,5)]
...
#export the csv file
write.table(Out2008, file = "WBD2008.csv", row.names = FALSE, col.names = TRUE, na = "", sep=",")
colnames(Out2008)<-c("CN",	"GDP",	"FDINI", "NFA",	"GDPg",	"GDPpcg",	"GCaFg",	"Ind1",	"ind2",	"Ser",	"ExGSgp",	
                     "ADRold",	"ADRyoun",	"PPg",	"PPf",	"PPm",	"PP1519f",	"PP1519m",	"PP2024f",	"PP2024m",	
                     "PP2529m",	"PP2529f",	"PP65above",	"PP65afnum",	"PP65af",	"PP1564m",	"PP1564f",	"Lab1524f",	
                     "Lab1524m",	"Lab1524tot",	"Labf",	"Labtot",	"RFtoMlabpartcp")
summary(Out2008)
write.table(Out2008, file = "SN2008.csv", row.names = FALSE, col.names = TRUE, na = "", sep=",")
...
#export the csv file
write.table(Out2009, file = "WBD2009.csv", row.names = FALSE, col.names = TRUE, na = "", sep=",")
colnames(Out2009)<-c("CN",	"GDP",	"FDINI", "NFA",	"GDPg",	"GDPpcg",	"GCaFg",	"Ind1",	"ind2",	"Ser",	"ExGSgp",	
                     "ADRold",	"ADRyoun",	"PPg",	"PPf",	"PPm",	"PP1519f",	"PP1519m",	"PP2024f",	"PP2024m",	
                     "PP2529m",	"PP2529f",	"PP65above",	"PP65afnum",	"PP65af",	"PP1564m",	"PP1564f",	"Lab1524f",	
                     "Lab1524m",	"Lab1524tot",	"Labf",	"Labtot",	"RFtoMlabpartcp")
summary(Out2009)
write.table(Out2009, file = "SN2009.csv", row.names = FALSE, col.names = TRUE, na = "", sep=",")
#-----------------------------------------2010----------------------------------------------------------
...
#export the csv file
write.table(Out2010, file = "WBD2010.csv", row.names = FALSE, col.names = TRUE, na = "", sep=",")
colnames(Out2010)<-c("CN",	"GDP",	"FDINI", "NFA",	"GDPg",	"GDPpcg",	"GCaFg",	"Ind1",	"ind2",	"Ser",	"ExGSgp",	
                     "ADRold",	"ADRyoun",	"PPg",	"PPf",	"PPm",	"PP1519f",	"PP1519m",	"PP2024f",	"PP2024m",	
                     "PP2529m",	"PP2529f",	"PP65above",	"PP65afnum",	"PP65af",	"PP1564m",	"PP1564f",	"Lab1524f",	
                     "Lab1524m",	"Lab1524tot",	"Labf",	"Labtot",	"RFtoMlabpartcp")
summary(Out2010)
write.table(Out2010, file = "SN2010.csv", row.names = FALSE, col.names = TRUE, na = "", sep=",")
...
#export the csv file
write.table(Out2011, file = "WBD2011.csv", row.names = FALSE, col.names = TRUE, na = "", sep=",")
colnames(Out2011)<-c("CN",	"GDP",	"FDINI", "NFA",	"GDPg",	"GDPpcg",	"GCaFg",	"Ind1",	"ind2",	"Ser",	"ExGSgp",	
                     "ADRold",	"ADRyoun",	"PPg",	"PPf",	"PPm",	"PP1519f",	"PP1519m",	"PP2024f",	"PP2024m",	
                     "PP2529m",	"PP2529f",	"PP65above",	"PP65afnum",	"PP65af",	"PP1564m",	"PP1564f",	"Lab1524f",	
                     "Lab1524m",	"Lab1524tot",	"Labf",	"Labtot",	"RFtoMlabpartcp")
summary(Out2011)
write.table(Out2011, file = "SN2011.csv", row.names = FALSE, col.names = TRUE, na = "", sep=",")
...
#export the csv file
write.table(Out2012, file = "WBD2012.csv", row.names = FALSE, col.names = TRUE, na = "", sep=",")
colnames(Out2012)<-c("CN",	"GDP",	"FDINI", "NFA",	"GDPg",	"GDPpcg",	"GCaFg",	"Ind1",	"ind2",	"Ser",	"ExGSgp",	
                     "ADRold",	"ADRyoun",	"PPg",	"PPf",	"PPm",	"PP1519f",	"PP1519m",	"PP2024f",	"PP2024m",	
                     "PP2529m",	"PP2529f",	"PP65above",	"PP65afnum",	"PP65af",	"PP1564m",	"PP1564f",	"Lab1524f",	
                     "Lab1524m",	"Lab1524tot",	"Labf",	"Labtot",	"RFtoMlabpartcp")
summary(Out2012)
write.table(Out2012, file = "SN2012.csv", row.names = FALSE, col.names = TRUE, na = "", sep=",")
#----------------------------------------------2013---------------------------------------------------
...
#export the csv file
write.table(Out2013, file = "WBD2013.csv", row.names = FALSE, col.names = TRUE, na = "", sep=",")
colnames(Out2013)<-c("CN",	"GDP",	"FDINI", "NFA",	"GDPg",	"GDPpcg",	"GCaFg",	"Ind1",	"ind2",	"Ser",	"ExGSgp",	
                     "ADRold",	"ADRyoun",	"PPg",	"PPf",	"PPm",	"PP1519f",	"PP1519m",	"PP2024f",	"PP2024m",	
                     "PP2529m",	"PP2529f",	"PP65above",	"PP65afnum",	"PP65af",	"PP1564m",	"PP1564f",	"Lab1524f",	
                     "Lab1524m",	"Lab1524tot",	"Labf",	"Labtot",	"RFtoMlabpartcp")
summary(Out2013)
write.table(Out2013, file = "SN2013.csv", row.names = FALSE, col.names = TRUE, na = "", sep=",")
#----------------------------------------------2014---------------------------------------------------
...
#export the csv file
write.table(Out2014, file = "WBD2014.csv", row.names = FALSE, col.names = TRUE, na = "", sep=",")
colnames(Out2014)<-c("CN",	"GDP",	"FDINI", "NFA",	"GDPg",	"GDPpcg",	"GCaFg",	"Ind1",	"ind2",	"Ser",	"ExGSgp",	
                     "ADRold",	"ADRyoun",	"PPg",	"PPf",	"PPm",	"PP1519f",	"PP1519m",	"PP2024f",	"PP2024m",	
                     "PP2529m",	"PP2529f",	"PP65above",	"PP65afnum",	"PP65af",	"PP1564m",	"PP1564f",	"Lab1524f",	
                     "Lab1524m",	"Lab1524tot",	"Labf",	"Labtot",	"RFtoMlabpartcp")
summary(Out2014)
write.table(Out2014, file = "SN2014.csv", row.names = FALSE, col.names = TRUE, na = "", sep=",")
#----------------------------------------------2015---------------------------------------------------
...
#export the csv file
write.table(Out2015, file = "WBD2015.csv", row.names = FALSE, col.names = TRUE, na = "", sep=",")
colnames(Out2015)<-c("CN",	"GDP",	"FDINI", "NFA",	"GDPg",	"GDPpcg",	"GCaFg",	"Ind1",	"ind2",	"Ser",	"ExGSgp",	
                     "ADRold",	"ADRyoun",	"PPg",	"PPf",	"PPm",	"PP1519f",	"PP1519m",	"PP2024f",	"PP2024m",	
                     "PP2529m",	"PP2529f",	"PP65above",	"PP65afnum",	"PP65af",	"PP1564m",	"PP1564f",	"Lab1524f",	
                     "Lab1524m",	"Lab1524tot",	"Labf",	"Labtot",	"RFtoMlabpartcp")
summary(Out2015)
write.table(Out2015, file = "SN2015.csv", row.names = FALSE, col.names = TRUE, na = "", sep=",")
#----------------------------------------------2016---------------------------------------------------
...
#export the csv file
write.table(Out2016, file = "WBD2016.csv", row.names = FALSE, col.names = TRUE, na = "", sep=",")
colnames(Out2016)<-c("CN",	"GDP",	"FDINI", "NFA",	"GDPg",	"GDPpcg",	"GCaFg",	"Ind1",	"ind2",	"Ser",	"ExGSgp",	
                     "ADRold",	"ADRyoun",	"PPg",	"PPf",	"PPm",	"PP1519f",	"PP1519m",	"PP2024f",	"PP2024m",	
                     "PP2529m",	"PP2529f",	"PP65above",	"PP65afnum",	"PP65af",	"PP1564m",	"PP1564f",	"Lab1524f",	
                     "Lab1524m",	"Lab1524tot",	"Labf",	"Labtot",	"RFtoMlabpartcp")
summary(Out2016)
write.table(Out2016, file = "SN2016.csv", row.names = FALSE, col.names = TRUE, na = "", sep=",")
#----------------------------------------------2017---------------------------------------------------
...
#export the csv file
write.table(Out2017, file = "WBD2017.csv", row.names = FALSE, col.names = TRUE, na = "", sep=",")
colnames(Out2017)<-c("CN",	"GDP",	"FDINI", "NFA",	"GDPg",	"GDPpcg",	"GCaFg",	"Ind1",	"ind2",	"Ser",	"ExGSgp",	
                     "ADRold",	"ADRyoun",	"PPg",	"PPf",	"PPm",	"PP1519f",	"PP1519m",	"PP2024f",	"PP2024m",	
                     "PP2529m",	"PP2529f",	"PP65above",	"PP65afnum",	"PP65af",	"PP1564m",	"PP1564f",	"Lab1524f",	
                     "Lab1524m",	"Lab1524tot",	"Labf",	"Labtot",	"RFtoMlabpartcp")
summary(Out2017)
write.table(Out2017, file = "SN2017.csv", row.names = FALSE, col.names = TRUE, na = "", sep=",")